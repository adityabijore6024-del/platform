...
SECRET_KEY = 'django-insecure-$-$q(@$@bz+31i!e&h%5r_f&o2n0*vgwpospn@gdx68#9c@g+-'
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # <--- Yeh nayi line yahan add karein
    # ... baaki saare middleware waise hi rahenge ..
